...
const FormSchemaEditProfileBasicInfo = z.object({
...
const FormSchemaEditProfileChangePassword = z
  .object({
    oldPassword: z.string().min(6, "Mật khẩu phải ít nhất 6 ký tự"),
    password: z.string().min(1, "Mật khẩu phải ít nhất 6 ký tự"),
    passwordConfirmation: z
      .string()
      .min(1, "Tên không được để trốngMật khẩu phải ít nhất 6 ký tự"),
  })
  .refine(
    (values) => {
...
type EditProfileBasicInfoFormData = z.infer<
  typeof FormSchemaEditProfileBasicInfo
>

type EditProfileChangePasswordFormData = z.infer<
  typeof FormSchemaEditProfileChangePassword
>
